...
import { OrganizationProps, PageProps, UserProps } from "../interfaces/interfaces";
...
export function Component() {
    ...
    return (
        ...
        <Box className="collection" mb={"5"} style={{ display: "flex", flexWrap: "wrap" }} >
            <Box p={"2"} width={"100%"}>
            ...
            {Object.keys(pages).map(v=>(
                <Block h="120px" w="29%" bg="#DB3A34" head={pages[v].name} body="Page body (Content)" data={pages[v]}/>
            ))}
